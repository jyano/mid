...
Bb.$ = $;Bb.emulateHTTP = false;Bb.emulateJSON = false; //for legacy bws
unds()
evens()
...
_.x(Collection.prototype, Events, {
    ...
    sort: function(options) {
        ...
        if (_.isFunction(comparator)) comparator = _.b(comparator, this);
...
var View = Bb.View = function(options) {
    ...
    _.x(this, _.pick(options, viewOptions));
    this._ensureElement();
    this.initialize.apply(this, arguments);
};
