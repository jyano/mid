...
$('#post_caption').submit(function() { 
 ...
 $.get(
     ...
     topic: <?= "\"$topic\"" ?>,
     picture: <?= "\"$picture\"" ?>,
     new_caption: document.post.new_caption.value,
     act: "post_caption"

    }, function() {

$.get("http://www.dirtpage.com/divfillers/picture.php",
...
$('.down').click(function() {
$.get("http://www.dirtpage.com/resources/datacalls.php", {
 caption_id: this.name, act: "caption_down", picture: <?= "\"$picture\"" ?>}, function() {
$.get("http://www.dirtpage.com/divfillers/picture.php", {
...
$('.del').click(function(){
 ...
 if ("<?= $_SESSION['admin']?>" == "yes") {
  ...
  $.get("http://www.dirtpage.com/datacalls", {
       topic: <?php echo "\"$theirName\"" ?>, messagenumber: $j, act: "deletemessage"}, function() {
