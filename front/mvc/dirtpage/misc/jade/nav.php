...
case "active":
 ...
 <h3> Recently voted on </h3>



while(   people.find().orderBy(date DESC).limit(50).exec()     ){
...
<A HREF="http://www.dirtpage.com/page/    str_replace(" ", "+", $row['person'])    >
 ...
 case "random":
	 ...
	 <span class =  "pinktitle">   random items</span> <br><br>
...
if 	($row['table_name'] == 'pictures') {
 ...
 <table ><tr ><td valign = "top"><span class="smallwhite">   $i  </span> </td>

 <td valign = "top"><A HREF=\"page/?topic=" . str_replace(" ", "+", $row['topic']). "\"><span class = \"smallyellow\">&nbsp;". $row['topic'] ." : </span></a></td>";


 <td valign = "top">  &nbsp  <a href = \"http://www.dirtpage.com/page.php?topic="   $row['topic']     "&mode=picture&picture="   $row['item']    "\"><img src=\"pictures/".  $row['item'] . "\" height=\"150\" border=\"black\"></a></td>";
 <td valign = "top">"
...
while($row = mysql_fetch_array($result)){
  ...
  <span class = "dirt">
  <A HREF="http://www.dirtpage.com/page.php?topic=    str_replace(" ", "+", $row['person'])   ">
	

	
 <li><span class = "topic"><span class = "expandable">    strtolower($row['person'])  </span></span></a> <span class = "comment">     "(". $row['COUNT(comment)'] ." messages)</span></li></span>";
...
while($row = mysql_fetch_array($result)){
 ...
 <li><span class = "bigred"><span class = "expandable">    strtolower($row['tag']) .   </span></span></a> &nbsp;<span class = \"comment\">          . "(". $row['COUNT(tag)'] ." topics)</span></li></span>";
...
echo "<li><span class = \"topic\">" .$row['person'] . " : " . "</span></a>" . 
 ...
 <li>
 <span class = "garbage">" .$row['person'] . " : " . "</span></a>
	"<span class = "garbage">"     .
...
<span class = "dirt"><A HREF="http://www.dirtpage.com/page.php?topic=confessions"><span class = "topic"> <span class = "expandable">confessions</span></span> </A></span><br><br>
 ...
 <span class = "dirt"><A HREF="http://www.dirtpage.com/page.php?topic=bad+first+date+comments">
 <span class = "topic"> <span class = "expandable">bad first date comments</span> </span> </A></span><br><br>
