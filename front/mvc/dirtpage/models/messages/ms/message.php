...
$.get("http://www.dirtpage.com/resources/datacalls.php", {message_id: <?php echo "\"$message\"" ?>, new_response: document.post.new_response.value, act: "post_response",topic: <?php echo "\"$topic\"" ?>}, function()
{
...
{response_id: this.name, act: "response_up"},
