...
//
 ...
 echo "<span class=\"pinktitle\">dirtpage : <A HREF=\"page.php?topic=" . str_replace(" ", "+", $topic) . "\"><span class=\"pinktitle\">" . strtolower($topic) . "</span></a> : see also</span>"; 
...
<input id="button" type="submit" value="add new 'see also'">
   </form> <br /><br />
...
?><A HREF="../../x/page?topic=<?php echo str_replace(" ", "+", $row['see_also']); ?>">

<?php           
echo "<span class = \"topic\">" . ($row['see_also']) . "</span></a></td>"  ;
...
<a href="javascript:void(0)"> <img class = <?php echo $class2 ?> name ="<?php echo $row['see_also_id']; ?>" src="<?php echo $pic2 ?>"  border = "0"/> </a><span class ="del" name="<?php echo $row['message_id']?>"></span>
 <br><br></li>
 <?php  ;
...
$.get("http://www.dirtpage.com/x/divfillers/see_also", { topic: <?php echo "\"$topic\"" ?>}, function(data) {
  $('#see_also').html(data);});
});
 });
