...
$ev.E.C = function () {
	return ev.Em.listenerCount()
}//(em, ev) >> num lsnrs for an ev
$ev.E.maxL = function () {
}//Em.defaultMaxListeners  // set max lisnrs at class level
UrLs = function () {
	$ev.E.call(this)
}// Inheriting the constructor isn't enough
$u.ih(UrLs, $ev.E)// use  util module to  inherit the prototype 
// This will add everything that's on $ev.E.prototype to UserList.prototype;  
// now our UserList instances will have all  // mets of an $ev.E instance.
UrLs.prototype.sv = function (d) {
	d.id = id++;
	db.urs.push(obj);
	this.em("saved-user", d)
}
UrLs.prototype.all = function () {
	return db.urs
}
$evOb = {
	d: 'data', cl: 'close',
	m: 'message', c: 'connection', nL: 'newListener',
	rL: 'removeListener', xL: 'removeListener', z: 'error'
}
evs = {arrival: [fn1, fn2], done: [fn1, fn2, fn3], msg: [fn]}
ex = function () {
	id = 1;
	db = {
		users: [
...
$EventEmitter = $Em = function () {
	return $sEm(new $ev.E())
}
$superEventEmitter=$sEm = function (e) {
	e.o = function (ev, fn) {
		var e = this
		if (S(ev) && U(fn)) {
...
function native(e) {
 ...
 // native evs:  newListener   removeListener
	e.o.nL = function (fn) {return this('nL', fn)}
	e.o.xL = function (fn) {return this('rL', fn)}
