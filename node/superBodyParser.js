...
//Rets j-prsg mw   -accepts any Unicode enc of bd  +autoInfl
...
$bP.t = function (){
	$bP.text.apply($bP,arguments)
	//$bP.t({})//  Rets mw that parses all bds as a $S      +autoInfl
...
$bP.r = function () {//    bP.r({})// Rets mw that parses all bds as Bf,   +autoInfl
...
//  $e.bdP( __dirname+"/public/uploads", true),
 ...
 function ditto(){//  4 prsrs:  jbd     RawBd    TxBd    URL-encFormBd
	 var $bP = require('body-parser')
	 $bP.j = function (o) {//Rets j-prsg mw   -accepts any Unicode enc of bd  +autoInfl
		 //   new bd ob  w  prsd data  popd on   qOb aft mw (q.b)
		 //   inflate   limit   verify  type
