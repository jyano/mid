 <span class=\"garbage\">external link [edit]</span>";

 <input type="button" value ="try me!"><?php
 
 <form name="post_see_also"id="post_see_also" onSubmit="return false;"><br />
</h1><span id="post">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <input type="text" name="newmessage" size="28" value="" maxlength="125" autocomplete="off"></span>
...
echo  "<li>";  ?><A HREF="../../x/page?topic=<?php echo str_replace(" ", "+", $row['see_also']); ?>"><?php
         echo "<span class = \"topic\">" . ($row['see_also']) . "</span></a>"   .  "<span class = \"t\">".  " (" . $row['score']. ") </span>&nbsp; ";
...
<a href="javascript:void(0)"> <img class = <?php echo $class1 ?> name ="<?php echo $row['see_also_id']; ?>"
     src="<?php echo $pic1 ?>" border = "0"/> </a>
<a href="javascript:void(0)"> <img class = <?php echo $class2 ?> name ="<?php echo $row['see_also_id']; ?>"
     src="<?php echo $pic2 ?>"  border = "0"/> </a><span class ="del" name="<?php echo $row['message_id']?>">
