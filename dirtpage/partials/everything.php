...
$messageNumber = $_GET['messagenumber'];
 ...
 <span class="pinktitle">dirtpage : <A HREF="page.php?topic=" +
  str_replace(" ", "+", $topic)  \><span class="pinktitle">
   strtolower($topic)
...
<a href="javascript:void(0)"> <img class = <?php echo $class2; ?> name ="<?php echo $row['id']; ?>" src="<?php echo $pic2; ?>"  border = "0"/> </a><br>
 <a href = \"http://www.dirtpage.com/x/page.php?topic=". $topic . "&mode=picture&picture=". $row['item'] . "\">"?> <span class ="del" name="<?php echo $row['item_id']; ?>"><image src = "../../../x/graphics/deeper2.jpg"></span></a>


 </td>
<td valign = "bottom"><span class = "smallblack">
hellooooooo well now that i have your attention.. i wanted to say..
i'm a stupid idiot!!! haha
</span>
