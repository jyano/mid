<span id="admin">
    <?php echo $_SESSION['admin_text'];  ?>
</span>

<link rel="stylesheet" href="../../../x/styles.css" type="text/css">
...
<span name ="admin" class="admin">
    <span name = "password" class="password">
...
<div id="logo">
<a href="http://www.dirtpage.com/x/default.php"><span style="color: green; font-size: 40">dirt</span><span style="color:white; font-size: 40">page</span></a></span> <br />
</div>
