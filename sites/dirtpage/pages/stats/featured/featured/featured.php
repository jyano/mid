...
</script><body onLoad="document.form1.comment.focus()">
</head>
...
echo "<br>  <i> <h3> featured topic: \"confessions\"   </i>   </h3>  ";



$query = "SELECT * FROM people WHERE person = 'confessions' ORDER BY id DESC LIMIT 500"; 
