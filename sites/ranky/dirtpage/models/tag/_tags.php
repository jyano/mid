...
//start a table and open first row and cell
echo "<table cellspacing=\"5\"><tr><td>";

//cell 1: include a 'left' graphic, and make it a link -> topic page
...
//select all tags of this specific topic !
//people can vote tags up and down !
...
else {$pic2 = "http://www.dirtpage.com/graphics/up.png";
    $class2 = "up"; $pic1 = "http://www.dirtpage.com/graphics/down.png";
    $class1 = "down";   }?>
...
$.get(
    "http://www.dirtpage.com/resources/datacalls.php",

    {topic: <?php echo "\"$topic\"" ?>,
        new_tag: document.post_tag.new_tag.value, act: "post_tag"
    }, function() {



        $.get("http://www.dirtpage.com/divfillers/tags.php",

            { topic: <?php echo "\"$topic\"" ?>}, function(data) {
...
$('.up').click(function() {
    ...
    $.get("http://www.dirtpage.com/resources/datacalls.php",

        {tag_id: this.name, act: "tag_up"}, function() {

    $.get("http://www.dirtpage.com/divfillers/tags.php",

        {topic: <?php echo "\"$topic\"" ?>, message: <?php echo "\"$message_id\"" ?>}, function(data) {
...
$('.down').click(function() {
$.get(
    "http://www.dirtpage.com/resources/datacalls.php", {tag_id: this.name, act: "tag_down"}, function() {

        $.get(
    "http://www.dirtpage.com/divfillers/tags.php", {topic: <?php echo "\"$topic\"" ?>, message: <?php echo "\"$message_id\"" ?>}, function(data) {
