...
CSSTextFont()
Events = {
	$: 'click', $$: 'dblclick', d: 'mousedown', o: 'mouseout', v: 'mouseover',
...
bootStrap = function () {
	CLASS = {
		...
		bb: 'btn-block',
		bg: 'btn-group',
		bgj: 'btn-group-justified',
		bgv: 'btn-group-vertical',
		bt: 'button',
		bdf: 'button-default',
		btp: 'button-primary',
		C: 'caret',
		...
		cs: 'carousel',
		csi: 'carousel-inner',
		csi: 'carousel-indicators',
		csc: 'carousel-caption',
		csc: 'carousel-control',
		D: 'divider',
		dt: 'data-toggle',
		dg: 'data-target',
		dd: 'dropdown',
		...
		lg: 'list-group',
		lgi: 'list-group-item',
		lgih: 'list-group-item-heading',
		lgit: 'list-group-item-text',
		me: 'media',
		meb: 'media-body',
		meo: 'media-object',
		meh: 'media-heading',
		...
		nt: 'nav-tabs',
		nj: 'nav-justified',
		ntj: 'nav-tabs-justified',
		nb: 'navbar',
		nbn: 'navbar-nav',
		nbr: 'navbar-right',
		nbl: 'navbar-left',
		nbfb: 'navbar-fixed-bottom',
		nbft: 'navbar-fixed-top',
		nbst: 'navbar-static-top',
		nbB: 'navbar-brand',
		nbb: 'navbar-btn',
		nbh: 'navbar-header',
		nbc: 'navbar-collapse',
		...
		poc: 'popover-content',
		pb: 'progress-bar',
		pbs: 'progress-bar-success',
		pbi: 'progress-bar-info',
		pbw: 'progress-bar-warning',
		pbd: 'progress-bar-danger',
		pp: 'prettyprint',
		ps: 'pre-scrollable',
		pg: 'pager',
		pgn: 'pagination',
		...
		so8: 'col-sm-offset-8',
		so9: 'col-sm-offset-9',
		so10: 'col-sm-offset-10',
		so11: 'col-sm-offset-11',
		m1: 'col-md-1',
		m2: 'col-md-2',
		m3: 'col-md-3',
		m4: 'col-md-4',
		...
		mo8: 'col-md-offset-8',
		mo9: 'col-md-offset-9',
		mo10: 'col-md-offset-10',
		mo11: 'col-md-offset-11',
		l1: 'col-lg-1',
		l2: 'col-lg-2',
		l3: 'col-lg-3',
		l4: 'col-lg-4',
		...
		lo8: 'col-lg-offset-8',
		lo9: 'col-lg-offset-9',
		lo10: 'col-lg-offset-10',
		lo11: 'col-lg-offset-11',
	}
	GLYPH = {
