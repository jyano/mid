...
w.webBlocks=function() {var w=this
...
$superWebguy = function(p){p.canWeb = true
	p.shootWeb = function () {
...
w.WebGuy = function(x,y){var w=this
	var guy = w.addMe(4)
...
WG = WEBGUY = function () {Wor().G(40).C('p').webBlocks()
	
	w.TRACK(p = w.WebGuy(300, 300))
