$h = http = require('superHttp');
$p = path = require('superPath');
$f = fs = require('superFileSystem')
var contacts = [
	{
...
http.createServer(function (req, res) {
	...
	if (req.url === '/' && req.method === 'GET') {
		...
		fs.readFile(contactsFile, function (err, data) {
			if (err) {
				throw err
			}
			;
		...
		console.log('contacts!')//this is for json api
