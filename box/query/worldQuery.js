...
w.qA = function (fn, ab) {this.QueryAABB(fn, ab); return this}
w.qPt = w.q = w.qP =w.queryPt = w.query = function () {var w = this, g = G(arguments), o, 
	...
	var fn = function (f) {if (!f) {  alert('w.query !this(f)')}
	
	
		if (f.of(o.k) && f.tP(o.x, o.y)) {fx = f;  return false }
	...
	w.qA(fn, $AB(o.x, o.y))
	if (!fx) {return false}
	if (F(o.fn)) {_.b(o.fn, fx)(fx);  return w}
	return fx
...
w.Q = function () {
	...
	function qAFn(f) {o.n++
		$l('w.Q qAFn' + o.n)
		if (o.fn(f, f.B(), o.n) !== false) {return true}
	}
...
w.qPoint = function(){var g=G(arguments),o 
